...
//
//
//		// Consultation Slots Tab Permissions:
//		// Doctors/Admins manage slots; Patients book slots
//		bookBtn.setVisible(!isStaff);
//		addSlotBtn.setVisible(isStaff);
//		updateSlotBtn.setVisible(isStaff);
...
//
//
//		// Appointments & Tracking Tab Permissions:
//		// Check-In, Update Status, and Open Consultation are visible ONLY to Staff (Doctor/Admin)
//		checkInBtn.setVisible(isStaff);
//		updateStatusBtn.setVisible(isStaff);
//		openConsultBtn.setVisible(isStaff);
//		cancelBtn.setVisible(true); // Patients and staff can cancel appointments
//
//        // Show Admin Queue Dropdown Filter only if Administrator
//        queueHeaderPanel.setVisible(isAdmin);
